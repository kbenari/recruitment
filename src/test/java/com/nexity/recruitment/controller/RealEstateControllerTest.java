...
public class RealEstateControllerTest {
	private static final String FIND_BY_ID_1 = "{\"id\":1,\"surface\":45.0,\"titre\":\"appartement\",\"descriptif\":\"exemple d'appartement\",\"adresse\":\"20 rue GateVigne 78200 Mantes la jolie\",\"prix\":145000}";
	

	private static String FIND_ALL_RESULT="[{\"id\":1,\"surface\":45.0,\"titre\":\"appartement\",\"descriptif\":\"exemple d'appartement\",\"adresse\":\"20 rue GateVigne 78200 Mantes la jolie\",\"prix\":145000},{\"id\":2,\"surface\":1235.0,\"titre\":\"immeuble\",\"descriptif\":\"exemple d'immeuble\",\"adresse\":\"19 Rue de Vienne, 75801 Paris\",\"prix\":12000000}]";
	...
	public void findAll() throws Exception {
		...
		this.mockMvc.perform(get("/Annonces")).andExpect(status().isOk())
	...
	public void findByIdForFound() throws Exception {
		...
		this.mockMvc.perform(get("/Annonces/1")).andExpect(status().isOk())
	...
	public void noFoundeFindByIdForNoFound() throws Exception {
		...
		this.mockMvc.perform(get("/Annonces/1")).andExpect(status().isNotFound());
	}
	...
	public void saveForNonExisting() throws Exception {
		...
		this.mockMvc.perform(post("/Annonces").contentType(MediaType.APPLICATION_JSON).content( new ObjectMapper().writeValueAsString(realEstateToSave)))
